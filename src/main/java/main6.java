...
public class main6 {
    public static void main(String[] args) {
        ...
        Trainer2.setLearning_rate(0.1);
        Trainer2.setRandomMiltiper(1000);
        Trainer2.setResultTreshold(0.1);
        HashMap<String , Neiron> inputNeiron, hiddenNeiron, exitNeiron;

        inputNeiron = Trainer2.createNeironsMap(15, NeironType.INPUT);
        hiddenNeiron = Trainer2.createNeironsMap(96, NeironType.HIDDEN);
...
//        trainingData.addData(new InputData("111101101101111"),new OutputData("1010"));
//111000111001111
        //trainer2.save();
